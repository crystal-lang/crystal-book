...
| Library | Description | License |
|---------|-------------|---------|
| [PCRE2][libpcre] | See [_Regular expression engine_](#regular-expression-engine) | |
| [LLVM][libllvm] | See [_Other stdlib libraries_](#other-stdlib-libraries) | [Apache v2 with LLVM exceptions](https://llvm.org/docs/DeveloperPolicy.html#new-llvm-project-license-framework) |
...
| [libxml2][libxml2] | Optional dependency for docs sanitizer. May be disabled with the `-Dwithout_libxml2` compile-time flag. See [_Other stdlib libraries_](#other-stdlib-libraries) | [MIT](https://gitlab.gnome.org/GNOME/libxml2/-/blob/master/Copyright) |
