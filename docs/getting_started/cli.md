...
Now, let's run our application. We have two ways [using the compiler](../manuals/using_the_compiler/README.md):

1. [Build the application](../manuals/using_the_compiler/README.md#crystal-build) and then run it.
2. Compile and [run the application](../manuals/using_the_compiler/README.md#crystal-run), all in one command.
