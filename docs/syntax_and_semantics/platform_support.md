...
The requirements for _Tier 1_ may be partially fulfilled, but are lacking in some way that prevents a solid guarantee.
Details are described in the _Comment_ column.
