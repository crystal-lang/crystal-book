...
| Target                     | Description               | Supported versions                                                                         | Comment
| -------------------------- | ------------------------- | ------------------------------------------------------------------------------------------ | -------
| `x86_64-windows-msvc`      | x64 Windows (MSVC)        | 10+ *(expected to work on Windows 7+)*                                                     | :material-circle-slice-7: tests<br> :material-checkbox-marked-circle: builds
| `x86_64-windows-gnu`       | x64 Windows (MinGW-w64)   | 10+, MSYS2 `UCRT64` / `MINGW64` / `CLANG64` environment *(expected to work on Windows 7+)* | :material-circle-slice-7: tests<br> :material-checkbox-marked-circle: builds
