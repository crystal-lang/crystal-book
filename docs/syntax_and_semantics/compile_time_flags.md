...
The status can be queried from code via the macro method [`flag?`](https://crystal-lang.org/api/latest/Crystal/Macros.html#flag%3F%28name%29%3ABoolLiteral-instance-method). It receives the name of a flag as a string or symbol
...
There's also the macro method [`host_flag?`](https://crystal-lang.org/api/latest/Crystal/Macros.html#host_flag%3F%28name%29%3ABoolLiteral-instance-method)
